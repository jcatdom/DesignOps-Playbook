...
Un pequeño detalle es que deberás ponerle un nuevo nombre a tus colores reducidos. En este ejemplo `Bluestone` es el nuevo `Gray` y sus variaciones son `light` `lighter` `lightest` `dark` `darker`
