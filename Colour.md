...
We still don't have _Dark mode_ implemented in SUI Theme or Apps, but we are workling on it. Check the section [Colour Theming Multiplatform](Colour-theming-multiplatform.md) to see the specs and implementation in Figma.
